  ...
  <div class="appNav">
    <?php
      if (!empty($sectorData['prev_page_url'])) {
        echo "<div class='navButton navTrigger navPrevPage' data-url='partials/junkGrid.php?page=".$prevPage.$navQuery."'><i class='fa fa-chevron-left'></i></div>";
      }
      ...
      if (!empty($sectorData['next_page_url'])) {
        echo "<div class='navButton navTrigger navNextPage' data-url='partials/junkGrid.php?page=".$nextPage.$navQuery."'><i class='fa fa-chevron-right'></i></div>";
      }
      ?>
  </div>
